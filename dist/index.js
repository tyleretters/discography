...
var discography = [
    ...
    },
    {
        ...
        "notes": "<p>% ssh-keygen -t ed25519</p><p>Generating public/private ed25519 key pair.</p><p>Enter file in which to save the key (/Users/mbp/.ssh/id_ed25519):</p><p>Enter passphrase (empty for no passphrase):</p><p>Enter same passphrase again:</p><p>Your identification has been saved in /Users/mbp/.ssh/id_ed25519.</p><p>Your public key has been saved in /Users/mbp/.ssh/id_ed25519.pub.</p><p>The key fingerprint is:</p><p>SHA256:0kv7znEhupmnDG+eyQAwWNgt8kwKzosGi4hpAmtf7HY mbp@mbp</p><p>The key's randomart image is:</p><p>+--[ED25519 256]--+</p><p>| o..             |</p><p>|+o+ .            |</p><p>|=*o.             |</p><p>|+ooo   .         |</p><p>|B+. o . S . .    |</p><p>|X=   + o + . .   |</p><p>|= . o o + . .    |</p><p>|   . o E.O.o     |</p><p>|    . .o%++      |</p><p>+----[SHA256]-----+</p><p>% cat /Users/mbp/.ssh/id_ed25519</p><p>-----BEGIN OPENSSH PRIVATE KEY-----</p><p>b3BlbnNzaC1rZXktdjEAAAAABG5vbmUAAAAEbm9uZQAAAAAAAAABAAAAMwAAAAtzc2gtZW</p><p>QyNTUxOQAAACDIR6QeH9ppP9f9xexpPOx0xAmGzWcU3SwBjSl7OZh1zgAAAJB79qzIe/as</p><p>yAAAAAtzc2gtZWQyNTUxOQAAACDIR6QeH9ppP9f9xexpPOx0xAmGzWcU3SwBjSl7OZh1zg</p><p>AAAEA1ic72mxJXRvpnU74JYkpnyQ+RhVHBnNLmuSpq4YcQY8hHpB4f2mk/1/3F7Gk87HTE</p><p>CYbNZxTdLAGNKXs5mHXOAAAAB21icEBtYnABAgMEBQY=</p><p>-----END OPENSSH PRIVATE KEY-----</p><p>watch the recording of CIPHER SUITE (demo) at: https://www.twitch.tv/videos/964445530</p>",
        "credits": "<p>STUXNET is Tyler Etters.</p>",
        "project_slug": "stuxnet",
    ...
    },
    {
        ...
        "notes": "<p>Serial Index of Unclaimed Memories File 2, is comprised of nine seperate tracks (here called 'Movements'), and is akin to a stream of consciousness dialouge between failing super-computer systems. Almost enitrely ambient, File 2 explores an entirely different realm than File 1.</p>",
        "credits": "<p>Composed, produced, and engineered by Paul Petrosyan and Tyler Etters.</p>",
        "project_slug": "everything-comes-in-cycles-everything-fades-in-shades",
